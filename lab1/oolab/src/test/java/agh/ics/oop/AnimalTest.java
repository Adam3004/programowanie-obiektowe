...
//this class is no more useful because animal was edited and those tests were prepared to previous version (without map)
public class AnimalTest {
    ...
    public void beforeEach() {
        ...
        animal2 = new Animal(new RectangularMap(10,10));
        animal3 = new Animal(new RectangularMap(10,10));
        animal4 = new Animal(new RectangularMap(10,10));
        animal5 = new Animal(new RectangularMap(10,10));
        animal6 = new Animal(new RectangularMap(10,10));
    }
